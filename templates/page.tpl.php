...
<header class="row">
  <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12" id="logo">
    <h1 style="text-indent:-9999px; margin:0px;">Northern Illinois University Digital Library
      <object class="col-lg-10 col-md-10 col-sm-12" style="margin-left:-16px!important;">
        <a href="/" target="_self">
          <img alt="Northern Illinois University Digital Library" class="img-responsive" src="/sites/digital.lib.niu.edu/files/niudl_logo.png">
        </a>
      </object> 
    </h1>
  </div>
